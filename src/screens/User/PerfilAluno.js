...
const OPCOES_MODALIDADE = [
  ...
  },
  {
    ...
    desc: "Acompanhamento físico lado a lado durante a execução.",
    icon: "barbell-outline",
  },
  {
    id: "indiferente",
    titulo: "Ainda não sei",
    desc: "Estou aberto a propostas dos melhores profissionais.",
...
const OPCOES_OBJETIVO = [
  ...
  },
  {
    id: "hipertrofia",
    titulo: "Hipertrofia",
    desc: "Foco total em ganho de massa muscular e volume.",
    icon: "barbell-outline",
  },
  {
    id: "saude",
  ...
  },
  {
    id: "performance",
    titulo: "Performance",
    desc: "Evoluir no meu esporte ou superar limites atuais.",
    icon: "trophy-outline",
    hasSub: true,
  },
  {
    id: "outro",
    titulo: "Outro Foco",
    desc: "Tenho uma meta específica e exclusiva em mente.",
    icon: "star-outline",
    hasSub: false,
  },
];
...
const OPCOES_HISTORICO = [
  ...
  },
  {
    id: "inconstante",
    titulo: "Inconstante",
    desc: "Começo e paro. Tenho dificuldade em manter a rotina.",
    icon: "pulse-outline",
  },
  {
    id: "intermediario",
    titulo: "Intermediário",
    desc: "Treino com certa regularidade, busco evolução real.",
    icon: "fitness-outline",
  },
  {
    id: "avancado",
    titulo: "Avançado",
    desc: "Treino intensamente e tenho domínio das execuções.",
    icon: "rocket-outline",
  },
];
...
const OPCOES_LIMITACAO = [
  ...
  },
  {
    ...
    desc: "Sinto desconforto articular, muscular ou ósseo.",
  ...
  },
  {
    ...
    desc: "Lido com hipertensão, diabetes, asma, etc.",
    icon: "medkit-outline",
    hasSub: true,
  },
  {
...
const OPCOES_PERFIL = [
  {
    id: "acolhedor",
    titulo: "O Acolhedor",
    desc: "Paciente, didático e foca na minha adaptação.",
    icon: "happy-outline",
  },
  {
    id: "motivador",
    titulo: "O Motivador",
    desc: "Intenso, cobrador e não me deixa desistir nunca.",
    icon: "megaphone-outline",
  },
  {
    id: "tecnico",
    titulo: "O Professor",
    desc: "Foca em biomecânica e explica o porquê de tudo.",
    icon: "school-outline",
  },
  {
    id: "estrategista",
    titulo: "O Estrategista",
    desc: "Foco absoluto em planilhas, metas e progressão.",
...
const OPCOES_GENERO_TREINADOR = [
  {
    id: "Indiferente",
    titulo: "Indiferente",
    desc: "Foco apenas na qualidade técnica.",
    icon: "people-outline",
  },
  {
    id: "Mulher",
    titulo: "Apenas Mulheres",
    desc: "Prefiro treinar com uma treinadora.",
    icon: "woman-outline",
  },
  {
    id: "Homem",
    titulo: "Apenas Homens",
    desc: "Prefiro treinar com um treinador.",
    icon: "man-outline",
  },
];
...
const OPCOES_TURNO = [
  {
    ...
    desc: "Treinar cedo para começar o dia.",
    icon: "sunny-outline",
  },
  {
    id: "Tarde",
    titulo: "Tarde (12h às 18h)",
    desc: "Aproveito a tarde ou horário de almoço.",
    icon: "partly-sunny-outline",
  },
  {
    id: "Noite",
    titulo: "Noite (18h às 22h)",
    desc: "Treino após o trabalho ou estudos.",
    icon: "moon-outline",
  },
  {
    id: "Indiferente",
    titulo: "Horários Variados",
    desc: "Minha agenda é flexível.",
    icon: "shuffle-outline",
  },
];
...
const OPCOES_FREQUENCIA = [
  {
    ...
    desc: "Rotina apertada, mas quero dar o primeiro passo.",
    icon: "calendar-outline",
  },
  {
    id: "3-4",
    titulo: "3 a 4 dias por semana",
    desc: "Consigo manter uma constância saudável.",
    icon: "calendar-outline",
  },
  {
    id: "5-6",
    titulo: "5 a 6 dias por semana",
    desc: "Foco quase diário. O treino é prioridade.",
    icon: "flame-outline",
  },
  {
    id: "7",
    titulo: "Todos os dias",
    desc: "Não descanso, quero intensidade todos os dias.",
    icon: "flash-outline",
  },
];
...
const OPCOES_LOCAL = [
  {
    id: "academia",
    titulo: "Academias Comerciais",
    desc: "Redes grandes ou academias de bairro completas.",
    icon: "barbell-outline",
  },
  {
    id: "condominio",
    titulo: "Academia do Condomínio",
    desc: "Treino no prédio, com a estrutura disponível.",
    icon: "business-outline",
  },
  {
    id: "casa",
    titulo: "Em Casa / Domicílio",
    desc: "Treino com o peso do corpo ou acessórios próprios.",
    icon: "home-outline",
  },
  {
    id: "ar_livre",
    titulo: "Ao Ar Livre / Parques",
    desc: "Gosto de treinar em praças, praias ou quadras.",
    icon: "leaf-outline",
  },
];
...
const OPCOES_INVESTIMENTO = [
  {
    id: "base",
    titulo: "R$ 90 a 110 / mês",
    desc: "Custo-benefício ideal para iniciar com qualidade.",
    icon: "wallet-outline",
  },
  {
    id: "mid",
    titulo: "R$ 120 a 150 / mês",
    desc: "Profissionais especialistas e super bem avaliados.",
    icon: "star-outline",
  },
  {
    id: "premium",
    titulo: "A partir de R$ 160",
    desc: "Treinadores de Elite e acompanhamento VIP.",
...
export default function PerfilAluno({ navigation }) {
      ...
      if (data) {
        ...
        if (data.preferencias) {
          ...
          if (p.servicos_buscados) {
            if (
              p.servicos_buscados.includes("Consultoria") &&
              p.servicos_buscados.includes("Presencial")
            ) {
              setModalidade(
                OPCOES_MODALIDADE.find((m) => m.id === "indiferente"),
              );
            } else if (p.servicos_buscados.includes("Consultoria")) {
              setModalidade(
                OPCOES_MODALIDADE.find((m) => m.id === "Consultoria"),
              );
            } else if (p.servicos_buscados.includes("Presencial")) {
              setModalidade(
                OPCOES_MODALIDADE.find((m) => m.id === "Presencial"),
              );
            }
            ...
            setModalidade(
              OPCOES_MODALIDADE.find((m) => m.id === legacyMap[p.modalidade]) ||
                null,
            );
          }
          ...
          setHistorico(
            OPCOES_HISTORICO.find((h) => h.id === p.historico) || null,
          );
          setLimitacao(
            OPCOES_LIMITACAO.find((l) => l.id === p.limitacao) || null,
          );
          setSubLimitacao(p.sub_limitacao || []);
          setOutraLimitacaoTexto(p.detalhe_outra_limitacao || "");
          setPerfilPersonal(
            OPCOES_PERFIL.find((t) => t.id === p.perfil_treinador) || null,
          );

          setGeneroTreinador(
            OPCOES_GENERO_TREINADOR.find((g) => g.id === p.genero_treinador) ||
              null,
          );
          setTurnoPreferido(
            OPCOES_TURNO.find((t) => t.id === p.turno_preferido) || null,
          );
          setHorarioEspecifico(p.horario_especifico || "");

          setFrequencia(
            OPCOES_FREQUENCIA.find((f) => f.id === p.frequencia) || null,
          );
          setLocalTreino(
            OPCOES_LOCAL.find((l) => l.id === p.local_treino) || null,
          );
          setInvestimento(
            OPCOES_INVESTIMENTO.find((i) => i.id === p.investimento) || null,
          );
        }
      }
    } catch (error) {
  ...
  const escolherFoto = async () => {
    ...
    if (status !== "granted")
      return Alert.alert("Atenção", "Precisamos de acesso à galeria.");
  ...
  const buscarLocalizacao = async () => {
    ...
    try {
      ...
      if (status !== "granted")
        return Alert.alert("Atenção", "Permita o acesso à localização.");
      ...
      {opcoes.map((opt) => {
        ...
        return (
          <TouchableOpacity
            key={opt.id}
            style={[
              styles.premiumOptionCard,
              ativo && styles.premiumOptionCardAtivo,
            ]}
            onPress={() =>
              isLocked ? handleLockedPress() : setStateObject(opt)
            }
          ...
          >
            ...
            <View
              style={[
                ...
                ativo && styles.premiumIconBoxAtivo,
              ]}
            >
              <Ionicons
                name={opt.icon}
                size={22}
                color={ativo ? theme.colors.backgroundPure : "#888"}
              />
            </View>
            <View style={styles.premiumTextContent}>
              <Text
                style={[
                  styles.premiumOptionTitle,
                  ativo && styles.premiumOptionTitleAtivo,
                ]}
              >
                {opt.titulo}
              </Text>
              {opt.desc && (
                <Text style={styles.premiumOptionDesc}>{opt.desc}</Text>
              )}
            </View>
            <View
      ...
      {opcoes.map((opt) => {
        ...
        return (
          <TouchableOpacity
            ...
            onPress={() =>
              toggleMultiSelect(opt.titulo, stateArray, setStateArray, isLocked)
            }
          ...
          >
            ...
            />
            <Text
              style={[styles.chipTexto, isSelected && styles.chipTextoAtivo]}
            >
              {opt.titulo}
            </Text>
          </TouchableOpacity>
  ...
  const handleSalvar = async () => {
    ...
    try {
      ...
      if (peso) {
        ...
        pesoNumerico = isNaN(parseFloat(pesoLimpo))
          ? null
          : parseFloat(pesoLimpo);
      }

      let alturaNumerica = null;
      if (altura) {
        const alturaLimpa = altura.toString().replace(",", ".");
        alturaNumerica = isNaN(parseFloat(alturaLimpa))
          ? null
          : parseFloat(alturaLimpa);
      }
      ...
      const preferencias = {
        ...
        outroObjetivo:
          objetivo?.id === "outro" ? outroObjetivoTexto.trim() : null,
        sub_objetivo:
          subObjetivo && subObjetivo.length > 0 ? subObjetivo : null,
        outroEsporte:
          subObjetivo && subObjetivo.includes("Outro")
            ? outroEsporteTexto.trim()
            : null,
        historico: historico?.id || null,
        limitacao: limitacao?.id || null,
        sub_limitacao:
          subLimitacao && subLimitacao.length > 0 ? subLimitacao : null,
        detalhe_outra_limitacao:
          subLimitacao && subLimitacao.includes("Outra")
      ...
      >
        <View style={styles.photoSection}>
          ...
          >
            ...
            >
              <Image
                source={{ uri: fotoUri || "https://via.placeholder.com/150" }}
        ...
        <View style={styles.cardGeral}>
          ...
          <View style={styles.formGroup}>
            ...
            >
              <Ionicons
                ...
                size={20}
                color={
                  inputFocado === "nome" ? theme.colors.primary : "#FF6B00"
                }
          ...
          <View style={styles.row}>
            <View style={[styles.formGroup, { flex: 1, marginRight: 8 }]}>
              ...
              <View
                style={[
                  styles.inputContainer,
                  inputFocado === "nasc" && styles.inputContainerFocused,
                ]}
              >
                <Ionicons
                  ...
                  size={18}
                  color={
                    inputFocado === "nasc" ? theme.colors.primary : "#FF6B00"
                  }
                  style={styles.inputIcon}
                />
                <TextInput
            ...
            <View style={[styles.formGroup, { flex: 1, marginLeft: 8 }]}>
              ...
              <View
                style={[
                  styles.inputContainer,
                  inputFocado === "whats" && styles.inputContainerFocused,
                ]}
              >
                <MaterialCommunityIcons
                  ...
                  size={18}
                  color={
                    inputFocado === "whats" ? theme.colors.primary : "#FF6B00"
                  }
                  style={styles.inputIcon}
                />
                <TextInput
          ...
          <TouchableOpacity
            style={styles.btnLocationPremium}
            ...
            {buscandoLocal ? (
              ...
              <>
                <MaterialCommunityIcons
                  ...
                  color={theme.colors.backgroundPure}
                />
                <Text style={styles.btnLocationText}>
          ...
          <Text style={styles.hintText}>
            O Radar conecta você aos melhores personais da sua região.
          </Text>
          ...
          <View style={styles.row}>
            <View style={[styles.formGroup, { flex: 1, marginRight: 8 }]}>
              ...
              <View
                style={[
                  styles.inputContainer,
                  inputFocado === "cidade" && styles.inputContainerFocused,
                ]}
              >
                <TextInput
            ...
            <View style={[styles.formGroup, { flex: 1, marginLeft: 8 }]}>
              ...
              <View
                style={[
                  styles.inputContainer,
                  inputFocado === "bairro" && styles.inputContainerFocused,
                ]}
              >
                <TextInput
                  style={styles.inputLocation}
          ...
          <View style={styles.row}>
            <View style={[styles.formGroup, { flex: 1, marginRight: 8 }]}>
              ...
              <View
                style={[
                  styles.inputContainer,
                  inputFocado === "peso" && styles.inputContainerFocused,
                ]}
              >
                <MaterialCommunityIcons
                  name="scale-bathroom"
                  size={18}
                  color={
                    inputFocado === "peso" ? theme.colors.primary : "#FF6B00"
                  }
                  style={styles.inputIcon}
                />
                <TextInput
            ...
            <View style={[styles.formGroup, { flex: 1, marginLeft: 8 }]}>
              ...
              <View
                style={[
                  styles.inputContainer,
                  inputFocado === "altura" && styles.inputContainerFocused,
                ]}
              >
                <MaterialCommunityIcons
                  ...
                  size={18}
                  color={
                    inputFocado === "altura" ? theme.colors.primary : "#FF6B00"
                  }
                  style={styles.inputIcon}
                />
                <TextInput
        ...
        {temPersonal ? (
          <View style={styles.statusBoxLocked}>
            ...
            />
            <Text style={styles.statusTextLocked}>
              Algumas preferências estão blindadas porque você possui uma
              consultoria ativa. Isso mantém seu planejamento seguro.
            </Text>
          </View>
        ) : (
          <View style={styles.statusBox}>
            ...
            <Text style={styles.statusText}>
              Estas tags guiam nossa Inteligência Artificial para achar o seu
              Match perfeito.
            </Text>
          </View>
        )}
        ...
        <View style={styles.preferenceCard}>
          <Text style={styles.cardHeaderTitleSub}>
            Como você prefere treinar? {temPersonal && "🔒"}
          </Text>
          {renderPremiumList(
            OPCOES_MODALIDADE,
            modalidade,
        ...
        <View style={styles.preferenceCard}>
          <Text style={styles.cardHeaderTitleSub}>
            Objetivo Principal {temPersonal && "🔒"}
          </Text>
          {renderPremiumList(
            OPCOES_OBJETIVO,
            objetivo,
          ...
          {objetivo?.id === "outro" && (
            <TouchableOpacity
              onPress={temPersonal ? handleLockedPress : null}
              activeOpacity={temPersonal ? 1 : 0.8}
            >
              <View pointerEvents={temPersonal ? "none" : "auto"}>
                <TextInput
                  style={[
                    styles.inputPremiumSmall,
                    temPersonal && { opacity: 0.5 },
                  ]}
                  placeholder="Digite seu foco (Ex: Autodefesa)"
                  placeholderTextColor="#666"
                  value={outroObjetivoTexto}
                  onChangeText={setOutroObjetivoTexto}
          ...
          {objetivo?.id === "saude" && (
            <View style={styles.subBox}>
              <Text style={styles.subBoxTitle}>Prioridade de Saúde:</Text>
              {renderChipsComIcone(
                SUB_SAUDE,
                subObjetivo,
                setSubObjetivo,
                ...
                >
                  <View pointerEvents={temPersonal ? "none" : "auto"}>
                    <TextInput
                      ...
                      placeholderTextColor="#666"
                      value={outroEsporteTexto}
                      onChangeText={setOutroEsporteTexto}
                      editable={!temPersonal}
                    />
                  </View>
                </TouchableOpacity>
        ...
        <View style={styles.preferenceCard}>
          <Text style={styles.cardHeaderTitleSub}>
            Limitações ou Cuidados {temPersonal && "🔒"}
          </Text>
          {renderPremiumList(
            OPCOES_LIMITACAO,
            limitacao,
          ...
          {limitacao?.id === "lesao" && (
            <View style={styles.subBox}>
              <Text style={styles.subBoxTitle}>Foco da dor:</Text>
              {renderChipsComIcone(
                SUB_LESAO,
                subLimitacao,
                setSubLimitacao,
                ...
                >
                  <View pointerEvents={temPersonal ? "none" : "auto"}>
                    <TextInput
                      ...
                      placeholderTextColor="#666"
                      value={outraLimitacaoTexto}
                      onChangeText={setOutraLimitacaoTexto}
                      editable={!temPersonal}
                    />
                  </View>
                </TouchableOpacity>
          ...
          {limitacao?.id === "clinica" && (
            <View style={styles.subBox}>
              <Text style={styles.subBoxTitle}>Condição médica:</Text>
              {renderChipsComIcone(
                SUB_CLINICA,
                subLimitacao,
                setSubLimitacao,
        ...
        <View style={styles.preferenceCard}>
          <Text style={styles.cardHeaderTitleSub}>
            Perfil de Professor Ideal {temPersonal && "🔒"}
          </Text>
          {renderPremiumList(
            OPCOES_PERFIL,
            perfilPersonal,
        ...
        <View style={styles.preferenceCard}>
          <Text style={styles.cardHeaderTitleSub}>
            Preferência de Gênero {temPersonal && "🔒"}
          </Text>
          {renderPremiumList(
            OPCOES_GENERO_TREINADOR,
            generoTreinador,
            setGeneroTreinador,
            temPersonal,
          )}
          ...
          {turnoPreferido && turnoPreferido.id !== "Indiferente" && (
            <View style={styles.subBox}>
              <Text style={styles.subBoxTitle}>
                Possui horário específico? (Opcional)
              </Text>
              <TouchableOpacity
                onPress={temPersonal ? handleLockedPress : null}
                activeOpacity={temPersonal ? 1 : 0.8}
        ...
        <View style={styles.preferenceCard}>
          <Text style={styles.cardHeaderTitleSub}>
            Disponibilidade na Semana {temPersonal && "🔒"}
          </Text>
          {renderPremiumList(
            OPCOES_FREQUENCIA,
            frequencia,
        ...
        <View style={styles.preferenceCard}>
          <Text style={styles.cardHeaderTitleSub}>
            Onde você prefere treinar? {temPersonal && "🔒"}
          </Text>
          {renderPremiumList(
            OPCOES_LOCAL,
            localTreino,
        ...
        <View style={styles.preferenceCard}>
          <Text style={styles.cardHeaderTitleSub}>
            Orçamento por Aula {temPersonal && "🔒"}
          </Text>
          {renderPremiumList(
            OPCOES_INVESTIMENTO,
            investimento,
...
const styles = StyleSheet.create({
  ...
  content: {
    padding: scale(20),
    paddingTop: Platform.OS === "ios" ? verticalScale(120) : verticalScale(100),
  ...
  avatarRing: { padding: scale(3), borderRadius: moderateScale(65) },
  avatarImage: {
    width: scale(116),
    height: scale(116),
  ...
  chipTexto: { color: "#888", fontSize: moderateScale(12), fontWeight: "700" },
