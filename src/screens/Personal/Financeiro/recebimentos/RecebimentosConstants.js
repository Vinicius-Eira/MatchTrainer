export const MODALIDADES = ["Todos", "Consultoria", "Presencial", "Híbrido"];
...
export const CATEGORIAS_EXTRA = ["Avaliação Física", "Planilha Extra", "E-book", "Aula Avulsa", "Outro"];
export const MOTIVOS_CONGELAMENTO = ["Férias", "Lesão", "Viagem", "Outro"];
