  ...
  const handleAtualizarSenha = async () => {
    ...
    try {
      ...
      if (sessionError || !session) {
        throw new Error(
          "Sua sessão de recuperação expirou ou não foi reconhecida. Por favor, clique no link do e-mail novamente.",
        );
      }
          ...
          <View style={styles.innerContent}>
            ...
            <View style={styles.header}>
              ...
              <Text style={styles.title}>
                Nova <Text style={styles.titleHighlight}>Senha.</Text>
              </Text>
              <Text style={styles.subtitle}>
                Crie uma credencial forte e única para proteger seus dados e
                treinos.
              </Text>
            </View>
            ...
            <View style={styles.form}>
              ...
              <View
                style={[
                  styles.inputBox,
                  focoConfirmar && styles.inputBoxFocused,
                ]}
              >
                <Ionicons
                  name="checkmark-circle-outline"
                  size={20}
                  color={focoConfirmar ? theme.colors.primary : "#666"}
                  style={styles.inputIcon}
                />
                <TextInput
                  style={[
            ...
            <View style={styles.trustBadgesContainer}>
              <View style={styles.securityCard}>
                ...
                <View style={styles.securityTextContent}>
                  ...
                  <Text style={styles.securityDesc}>
                    Sua senha é blindada e invisível no banco de dados. Nem
                    nossa equipe tem acesso.
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.securityCard}>
                ...
                <View style={styles.securityTextContent}>
                  ...
                  <Text style={styles.securityDesc}>
                    Ao atualizar, qualquer sessão logada em celulares antigos
                    será desconectada na hora.
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.securityCard}>
                ...
                <View style={styles.securityTextContent}>
                  ...
                  <Text style={styles.securityDesc}>
                    Sua credencial é atualizada instantaneamente. Salve e retome
                    seus treinos e rotinas.
                  </Text>
                </View>
              </View>
            </View>
