...
export default function AlunoCadastro({ navigation }: any) {
  ...
  const handleCadastro = async () => {
    if (!nome || !email || !senha || !confirmarSenha) return Alert.alert("Atenção", "Por favor, preencha todos os campos.");
    ...
    try {
      const { error } = await supabase.auth.signUp({
        ...
        options: {
          ...
          emailRedirectTo: "exp://192.168.15.26:8081/--/AlunoLogin", 
        },
      });
      ...
      <KeyboardAvoidingView style={styles.keyboardView} behavior={Platform.OS === "ios" ? "padding" : undefined} keyboardVerticalOffset={Platform.OS === "ios" ? 40 : 0}>
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.headerTextContainer}>
            ...
            <Text style={styles.subtitle}>Crie sua conta gratuitamente e encontre o profissional ideal para o seu objetivo.</Text>
          </View>

          <TouchableOpacity style={styles.vipButton} activeOpacity={0.8} onPress={() => navigation.navigate("AtivarConvite")}>
            <LinearGradient colors={["rgba(255, 107, 0, 0.15)", "rgba(255, 107, 0, 0.05)"]} style={StyleSheet.absoluteFill} />
            ...
            <View style={styles.vipButtonTextWrap}>
              ...
              <Text style={styles.vipButtonDesc}>Ativar meu código de convite</Text>
            </View>
          ...
          <View style={styles.form}>
            <View style={[styles.inputContainer, inputFocado === "nome" && styles.inputContainerFocused]}>
              ...
              <TextInput style={[styles.input, Platform.OS === "web" ? { outlineStyle: "none" as any } : {}]} placeholder="Como quer ser chamado?" placeholderTextColor="#555" value={nome} onChangeText={setNome} onFocus={() => setInputFocado("nome")} onBlur={() => setInputFocado(null)} autoCapitalize="words" autoCorrect={false} cursorColor={theme.colors.primary} keyboardAppearance="dark" />
            </View>
            ...
            <View style={[styles.inputContainer, inputFocado === "email" && styles.inputContainerFocused]}>
              ...
              <TextInput style={[styles.input, Platform.OS === "web" ? { outlineStyle: "none" as any } : {}]} placeholder="Seu melhor e-mail" placeholderTextColor="#555" keyboardType="email-address" autoCapitalize="none" autoCorrect={false} value={email} onChangeText={setEmail} onFocus={() => setInputFocado("email")} onBlur={() => setInputFocado(null)} cursorColor={theme.colors.primary} keyboardAppearance="dark" />
            </View>
            ...
            <View style={styles.buttonContainer}>
              <TouchableOpacity style={[styles.btnOutline, loading && { opacity: 0.7 }]} onPress={handleCadastro} disabled={loading} activeOpacity={0.8}>
                ...
                <Text style={styles.btnOutlineText}>{loading ? "Criando conta..." : "Criar Conta Grátis"}</Text>
          ...
          <View style={styles.benefitsWrapper}>
            ...
            <View style={styles.benefitCard}>
              <View style={styles.benefitIconBg}>
                <MaterialCommunityIcons name="magnify-scan" size={22} color={theme.colors.primary} />
              </View>
              <View style={styles.benefitTextWrap}>
                <Text style={styles.benefitTitle}>Busca Inteligente</Text>
                <Text style={styles.benefitDesc}>Profissionais qualificados perto de você.</Text>
              </View>
            </View>
            ...
            <View style={styles.benefitCard}>
              ...
              <View style={styles.benefitTextWrap}>
                ...
                <Text style={styles.benefitDesc}>Fale com treinadores sem intermediários.</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.footer}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("AlunoLogin")} activeOpacity={0.7} style={styles.footerButton}>
      ...
      <Modal visible={modalSucesso} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <TouchableOpacity style={styles.modalBtn} onPress={() => { setModalSucesso(false); navigation.navigate("AlunoLogin"); }} activeOpacity={0.8}>
...
const styles = StyleSheet.create({
  ...
  vipButton: { flexDirection: "row", alignItems: "center", backgroundColor: "#0A0A0A", borderWidth: 1, borderColor: "rgba(255, 107, 0, 0.4)", borderRadius: moderateScale(18), paddingVertical: verticalScale(16), paddingHorizontal: scale(20), marginBottom: verticalScale(28), overflow: 'hidden' },
  vipButtonTextWrap: { flex: 1, marginLeft: scale(14) },
  vipButtonTitle: { color: "#FFF", fontSize: moderateScale(15), fontFamily: theme.fonts.title, fontWeight: "bold", letterSpacing: 0.5 },
  vipButtonDesc: { color: "#AAA", fontFamily: theme.fonts.body, fontSize: moderateScale(12), marginTop: verticalScale(2) },
